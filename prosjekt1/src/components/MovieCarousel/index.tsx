...
const MovieCarousel: React.FC = () => {
    const { data, error, isLoading } = useQuery<Movie[]>({ queryKey: ['movies'], queryFn: fetchMovies });
    ...
    return (
      <div className={styles.movieCarousel}>
        ...
        <MovieBox posterPath={data![currentIndex].poster_path} title={data![currentIndex].title} />
